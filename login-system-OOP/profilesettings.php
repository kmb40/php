...
<div class = "container">  
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name="about" id="exampleFormControlTextarea1" rows="3"><?php $profileInfo->fetchAbout($_SESSION["userid"]);?></textarea>
      </div>        
    <div class="form-group">
        <label for="exampleFormControlTextarea1">Title</label>
        <textarea class="form-control" name="introtitle" id="exampleFormControlTextarea1" rows="3"><?php $profileInfo->fetchTitle($_SESSION["userid"]);?></textarea>
      </div>        
      <div class="form-group">
        <label for="exampleFormControlTextarea1">Text</label>
        <textarea class="form-control" name="introtext" id="exampleFormControlTextarea1" rows="3"><?php $profileInfo->fetchText($_SESSION["userid"]);?></textarea>
      </div>
